import { Browser, ChildProperty, Collection, Complex, Component, Draggable, Event, EventHandler, KeyboardEvents, L10n, NotifyPropertyChanges, Property, SanitizeHtmlHelper, Touch, addClass, append, classList, closest, compile, createElement, createInstance, debounce, detach, extend, formatUnit, initializeCSPTemplate, isNullOrUndefined, remove, removeClass, setStyleAttribute } from '@syncfusion/ej2-base';
...
class DragAndDrop {
    ...
    drag(e) {
        ...
        const firstCloneCard = this.parent.element.querySelector('.e-target-dropped-clone');
        let previousSiblingCard = null;
        ...
        if (contentCell && document.body.style.cursor !== 'not-allowed') {
            ...
            if (keys.length === 1 || isDrag) {
                ...
                else if ((target.classList.contains(CARD_WRAPPER_CLASS) || target.classList.contains(CARD_VIRTUAL_WRAPPER_CLASS)) &&
...
class LayoutRender extends MobileLayout {
    ...
    renderSingleContent(tBody, row, isCollaspsed) {
        ...
        const tr = createElement('tr', { className: className, attrs: { 'aria-expanded': 'true', 'role': 'row' } });
        for (const column of this.parent.columns) {
            if (this.isColumnVisible(column)) {
                const index = this.parent.actionModule.columnToggleArray.indexOf(column.keyField.toString());
            ...
            for (const column of this.parent.columns) {
                if (this.isColumnVisible(column)) {
                    const columnData = this.parent.swimlaneSettings.keyField ?
                        this.getColumnData(column.keyField, this.swimlaneData[rows[index].keyField]) :
                    ...
                    const cardWrapper = createElement('div', {
                        className: CARD_WRAPPER_CLASS, attrs: { 'role': 'listbox', 'tabindex': '0', 'aria-label': column.keyField.toString() }
                    });
